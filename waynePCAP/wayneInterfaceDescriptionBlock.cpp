...
namespace wayne {
	namespace PCAP {
		...
		interfaceDescriptionBlock::interfaceDescriptionBlock() 
		{
			...
			this->reserved = numberUtil::numberToBytesStatic((short)structByteDefault::IDB_RESERVED_VALUE, numberUtil::numberByteOrder::ORDER_DATA_DEFAULT);
		...
		interfaceDescriptionBlock::interfaceDescriptionBlock(const interfaceDescriptionBlock &other) 
		{
			...
			delete this->reserved;
			this->reserved = new char[(int)numberUtil::bytesStaticToNumber(other.reserved, numberUtil::numberTypeReference::DATA_TYPE_SHORT, numberUtil::numberByteOrder::ORDER_DATA_DEFAULT)];
		...
		{
			if (numberUtil::bytesStaticToNumber(this->linkType, numberUtil::numberTypeReference::DATA_TYPE_SHORT, numberUtil::numberByteOrder::ORDER_DATA_DEFAULT) != (numberUtil::bytesStaticToNumber(other.linkType, numberUtil::numberTypeReference::DATA_TYPE_SHORT, numberUtil::numberByteOrder::ORDER_DATA_DEFAULT)))
			{
				return false;
			}
			if (numberUtil::bytesStaticToNumber(this->linkType, numberUtil::numberTypeReference::DATA_TYPE_INTEGER, numberUtil::numberByteOrder::ORDER_DATA_DEFAULT) != (numberUtil::bytesStaticToNumber(other.linkType, numberUtil::numberTypeReference::DATA_TYPE_INTEGER, numberUtil::numberByteOrder::ORDER_DATA_DEFAULT)))
			{
				return false;
			}
			for (auto const& [key, option] : other.options)
		...
		{
			return (linkTypes)numberUtil::bytesStaticToNumber(this->linkType, numberUtil::numberTypeReference::DATA_TYPE_UNSIGNED_SHORT, numberUtil::numberByteOrder::ORDER_DATA_DEFAULT);
		}
		...
		{
			delete[] this->linkType;
			this->linkType = numberUtil::numberToBytesStatic((unsigned short)linkTypes::LINKTYPE_ETHERNET, numberUtil::numberByteOrder::ORDER_DATA_DEFAULT);
		}
		...
		{
			return numberUtil::bytesStaticToNumber(this->snapLength, numberUtil::numberTypeReference::DATA_TYPE_UNSIGNED_INTEGER, numberUtil::numberByteOrder::ORDER_DATA_DEFAULT);
		}
		...
		{
			delete[] this->snapLength;
			this->snapLength = numberUtil::numberToBytesStatic(newSnapLength, numberUtil::numberByteOrder::ORDER_DATA_DEFAULT);
		}
		...
		bool interfaceDescriptionBlock::setOption(optionTypes option, const char* value, unsigned int valueLength)
		{
			...
			if (isOptionAcceptable(option))
			{
				...
				// Appending new size.
				updateBlockLength(numberUtil::nextNearestMultOfXFromY((int)4 + (int)valueLength, (int)structByteLength::BLOCK_READ_UNIT)); //Add tghe size of the new data.
